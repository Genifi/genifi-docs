...
-   :material-api: **Backend API**

    ---

    Integrate Genifi into your own systems. Quotes, payments, webhooks, and the
    full endpoint reference.

    [:octicons-arrow-right-24: Read the API docs](backend/README.md)

-   :material-view-dashboard-outline: **Dashboard**

    ---

    Send and track payments from a web app. No code required.

    [:octicons-arrow-right-24: Open the guide](dashboard/README.md)
